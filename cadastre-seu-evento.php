<?php /* Template Name: Cadastre seu evento */ get_header("internas"); ?>
                    ...
                    <form method="post" action="<?php bloginfo("template_url"); ?>/report.php" enctype="multipart/form-data">
                        <div id="todoform">
                           ...
                           <p>
                            ...
                            <textarea cols="25" rows="10" id="datelist" name="data_evento" ></textarea>
                            ...
                            <p>
                                ...
                                <textarea cols="45" rows="5" name="legenda"></textarea><br />
                            </p>
                            
                            
                            <p>
                                <label for="creditos">Cr&eacute;ditos da foto:<strong> &nbsp;*</strong></label><br />
                                <textarea cols="45" rows="5" name="creditos"></textarea><br />
                            </p>
                            
                            
                            
                            <strong>Campos obrigat&oacute;rios</strong>
