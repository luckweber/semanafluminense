...
/*
 * Template name: Resultado Fotografias
 */
...
<div id="content">
	...
	$bloco_afj = bloco_fotografia($cat_adulto,$cat_tema_fragmentos, $cat_juri);
	$bloco_afp = bloco_fotografia($cat_adulto,$cat_tema_fragmentos, $cat_voto_popular);

	$bloco_amj = bloco_fotografia($cat_adulto,$cat_tema_memoria, $cat_juri);
	$bloco_amp = bloco_fotografia($cat_adulto,$cat_tema_memoria, $cat_voto_popular);

	$bloco_apj = bloco_fotografia($cat_adulto,$cat_tema_patrimonio, $cat_juri);
	$bloco_app = bloco_fotografia($cat_adulto,$cat_tema_patrimonio, $cat_voto_popular);
	?>
	...
	<?php 
		...
		$bloco_jfj = bloco_fotografia($cat_juvenil,$cat_tema_fragmentos, $cat_juri);
		$bloco_jfp = bloco_fotografia($cat_juvenil,$cat_tema_fragmentos, $cat_voto_popular);

		$bloco_jmj = bloco_fotografia($cat_juvenil,$cat_tema_memoria, $cat_juri);
		$bloco_jmp = bloco_fotografia($cat_juvenil,$cat_tema_memoria, $cat_voto_popular);

		$bloco_jpj = bloco_fotografia($cat_juvenil,$cat_tema_patrimonio, $cat_juri);
		$bloco_jpp = bloco_fotografia($cat_juvenil,$cat_tema_patrimonio, $cat_voto_popular);
	?>
